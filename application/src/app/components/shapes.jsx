...
function Geometries() {
    const geometries = [
        ...
        { position: [-1.4, 2, -4], r: 0.6, geometry: new THREE.DodecahedronGeometry(1.5) },
        { position: [-0.8, -0.75, 5], r: 0.5, geometry: new THREE.TorusGeometry(0.6, 0.25, 16, 32) },
        { position: [1.6, 1.6, -4], r: 0.7, geometry: new THREE.OctahedronGeometry(1.5) },
    ];
